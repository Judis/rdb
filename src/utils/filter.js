/**
 * Code from https://github.com/mapbox/mapbox-gl-js/tree/64e98417bf290bf9f3c893e20f1015f2d7769de0/src/style-spec/feature_filter
 * 
 * Usage instructions: https://www.mapbox.com/mapbox-gl-js/style-spec/#filter
 * Flow typed version: https://github.com/mapbox/mapbox-gl-js/blob/master/src/style-spec/feature_filter/index.js
 */
...
function compileComparisonOp(property, value, op, checkType) {
  ...
  return (
    (checkType ? `typeof ${left}=== typeof ${right}&&` : "") + left + op + right
  );
}
